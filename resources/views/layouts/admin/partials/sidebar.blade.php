<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="{{ $title == 'Gejala' ? 'active' : ''}}">
          <a href="{{route('admin.gejala.index')}}" class="nav-link"><i class="fas fa-columns"></i><span>Gejala</span></a>
        </li>
        <li class="{{ $title == 'Penyakit' ? 'active' : ''}}">
          <a href="{{route('admin.penyakit.index')}}" class="nav-link"><i class="fas fa-plus-square"></i><span>Penyakit</span></a>
        </li>
